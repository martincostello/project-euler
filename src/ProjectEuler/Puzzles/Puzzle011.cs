    ...
    protected override int SolveCore(string[] args)
    {
        ...
        for (int x = 0; x < width; x++)
        {
            for (int y = 0; y < height; y++)
            {
                if (y + 4 < height)
                {
                    sequences.Add([Grid[x][y], Grid[x][y + 1], Grid[x][y + 2], Grid[x][y + 3]]);
                }

                if (x + 4 < width)
                {
                    sequences.Add([Grid[x][y], Grid[x + 1][y], Grid[x + 2][y], Grid[x + 3][y]]);

                    if (y + 4 < height)
                    {
                        sequences.Add([Grid[x][y], Grid[x + 1][y + 1], Grid[x + 2][y + 2], Grid[x + 3][y + 3]]);
                    }
